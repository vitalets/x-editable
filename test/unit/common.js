...
//        equal(e3.data('editable').lastSavedValue, v, 'lastSavedValue taken from text correctly (escaped)');
    ...
    test("popup placement `auto` (BS3/BS4/BS5 only)", function () {
        //do not test inline  
        if($.fn.editable.defaults.mode === 'inline' || $.fn.editableform.engine !== 'bs3' || $.fn.editableform.engine !== 'bs4' || $.fn.editableform.engine !== 'bs5') {
            expect(0);
            return;
        }
